...
class Spider(Spider):
    ...
    def build_content(self, data):
        return '最新4k接口https://fzl4k.xyz' + data.get('data', {}).get('newsAbstract', '')
    ...
    def build_video_data(self, did, director, actor, remarks, year, area, content, bofang):
        return {"vod_id": did, "vod_director": director, "vod_actor": actor, "vod_remarks": remarks, "vod_year": year, "vod_area": area, "vod_content": content, "vod_play_from": "QQ交流群:212706934", "vod_play_url": bofang}
